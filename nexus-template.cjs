...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Professional Learning and Development System for Special Education in Inclusive Classrooms";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Educator Professional Development Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "educator_professional_development_record_records";
'use strict';
